        ...
        <div className="mx-auto max-w-7xl px-6 py-12 md:py-16 lg:px-8 lg:py-20">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-[auto_1fr_1fr_1fr] lg:gap-12">
            ...
            <div className="flex items-start">
              <Image
                src="/camino-legal-complete-white.png"
                alt="Camino Legal"
                width={120}
                height={85}
            ...
            <div className="flex flex-col gap-3 lg:gap-4">
              ...
              <div className="flex gap-4 lg:gap-5">
                ...
                >
                  <svg className="h-5 w-5 lg:h-6 lg:w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M7.953 15.066l-.038.001c-.036 0-.071-.001-.107-.004a1.26 1.26 0 01-.045-.005l.022-.001h.014l.154.009zm5.965-4.078L16.4 8.506h-2.482l2.482-2.482V3.542h-2.482L16.4 1.06h-2.482L12 3.542 10.082 1.06H7.6l2.482 2.482H7.6v2.482l2.482 2.482H7.6l2.482 2.482v2.482H7.6l2.482 2.482H7.6v2.482l2.482-2.482v2.482L12 20.458l1.918 2.482h2.482v-2.482l-2.482 2.482v-2.482h2.482l-2.482-2.482h2.482v-2.482l-2.482 2.482v-2.482z" />
                  </svg>
                </a>
              </div>
            </div>
