...
export default function Contact() {
  ...
  return (
    <section id="contact" className="mx-auto max-w-7xl px-6 py-12 md:py-16 lg:py-24 lg:px-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="relative flex items-start gap-4">
            <div className="relative">
              <Image src="/stickers/Recurso 88.png" alt="" width={100} height={100} aria-hidden
                className="w-20 lg:w-28 -rotate-12 drop-shadow-md pointer-events-none select-none" />
              <Image src="/stickers/Recurso 77.png" alt="" width={60} height={60} aria-hidden
                className="w-12 lg:w-16 rotate-12 absolute -bottom-4 -right-4 pointer-events-none select-none" />
            </div>
            <Image src="/stickers/Recurso 100.png" alt="" width={70} height={70} aria-hidden
          ...
          <div className="rounded-3xl border-2 border-foreground/8 bg-foreground/[0.02] p-6 md:p-8">
            {state?.success ? (
              <div className="flex flex-col items-center gap-5 text-center py-6">
                <Image src="/stickers/Recurso 101.png" alt="" width={100} height={100} aria-hidden
                  className="w-20 animate-bounce pointer-events-none select-none" />
                <p className="text-base md:text-lg font-bold">{state.message}</p>
                <p className="text-xs opacity-50">Te responderemos lo antes posible.</p>
              </div>
            ) : (
              <form action={action} className="flex flex-col gap-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="name" className="text-xs font-semibold opacity-50 uppercase tracking-wide">
                      Nombre completo
                    </label>
                    <input
                      id="name"
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label htmlFor="phone" className="text-xs font-semibold opacity-50 uppercase tracking-wide">
                      Tel&eacute;fono
                    </label>
                    <div className="flex items-center rounded-xl border-2 border-foreground/10 bg-background focus-within:border-primary/40 transition-colors duration-200">
                      <span className="pl-4 pr-2 text-sm text-foreground/40 select-none shrink-0">+52</span>
                      <span className="text-foreground/15 text-sm shrink-0">|</span>
                      <input
                        id="phone"
                        name="phone"
                        type="tel"
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="email" className="text-xs font-semibold opacity-50 uppercase tracking-wide">
                ...
                <div className="flex flex-col gap-1.5">
                  <label htmlFor="message" className="text-xs font-semibold opacity-50 uppercase tracking-wide">
